...
def Check_Config_File():
    ...
    print('Configuration file is checked for validity ...')
...
check_config_true = Check_Config_File()

if check_config_true == False:
    print('Configuration file check has failed and further steps are cancelled. Please adapt your configuration file and try again.')
else:
